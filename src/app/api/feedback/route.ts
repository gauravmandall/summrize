...
export async function POST(req: Request, res: Response) {
    try {
        ...
        const transporter = nodemailer.createTransport({
            service: "gmail",
            auth: {
                user: "mandalgaurav550@gmail.com", // Enter here email address from which you want to send emails
        ...
        const mailOptions = {
            from: email,
            to: "mandalgaurav550@gmail.com", // Enter here email address on which you want to send emails

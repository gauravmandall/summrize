  ...
  const generate = async () => {
    try {
      ...
      if (res instanceof Blob) {
        ...
        res.error &&
        res.error ===
          "Model runwayml/stable-diffusion-v1-5 is currently loading"
      ) {
        ...
        <div className="relative flex flex-col items-start justify-start w-full max-w-lg py-8 mr-auto">
          <form onSubmit={query2} className="w-full">
            <Label className="relative w-full">
              <span className="text-muted-foreground ml-0.5">Prompt</span>
              <Input
                name="prompt"
                value={prompt}
                disabled={isLoading}
          ...
          <div className="flex flex-col items-start w-full mt-12">
            <div className="flex itec' justify-between w-full">
              <span className="text-base font-medium">Generated Image</span>
            </div>
              ...
              {imgUrl && !isLoading && (
                <div className="relative flex flex-col w-full">
                  <Image
                    src={
                      imgUrl! ||
                      "https://huggingface.co/Melonie/text_to_image_finetuned/resolve/main/image_1.png"
                    }
                    alt="Generated Image"
                    width={500}
                    height={500}
